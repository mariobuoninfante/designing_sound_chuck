...
osc.freq(640);
osc.gain(0.5);  // scale oscillator amplitude

samp => now;

plot1.record(osc, (1000./640.)::ms);    // plot original signal
plot2.record(g, (1000./640.)::ms);      // plot shifted signal   (check y-axis)
1.1::second => now;
