// 13.5 signal reciprocal

Plot plot1;
Plot plot2;

Step _div => Gain div => blackhole;
Phasor phasor => Gain add => div;
Step _add => add;
div.op(4);  // to divide signals
_div.next(1);
_add.next(1);
phasor.freq(640);
...
plot1.record(phasor, (1000./640.)*2::ms);    // plot original signal
plot2.record(div, (1000./640.)*2::ms);      // plot inverted signal (check y-axis)
1.1::second => now;
